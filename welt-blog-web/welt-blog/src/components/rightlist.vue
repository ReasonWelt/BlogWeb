      ...
      <div class="r1-body">
        ...
        <div class="catch-me">
          <div class="">
            ...
            <el-tooltip class="item" effect="dark" content="Email:198466453@qq.com" placement="top">
              <a :href="catchMeObj.email" target="_blank"
...
<script>
import { hotArticleList,ArticleTotal } from "../api/article";
export default {
  data() {
    //选项 / 数据
    return {
      ...
      catchMeObj: {
        //个人信息
        git: "https://github.com/ReasonWelt",
...
.number{
  ...
  padding: 5px;
  // background-color: #df2050;
  transition: all 0.2s linear;
}

.articleTotal{
  background-color: #827f7f12;
  width: 30%;
  padding: 5px;
  transition: all 0.2s linear;
  border-radius: 5px;
  border: solid 1px rgba(103, 194, 251, 0);
}

.articleTotal:hover{
  border: solid 1px rgb(103, 194, 251);
  background-color: #7171712d;
}
