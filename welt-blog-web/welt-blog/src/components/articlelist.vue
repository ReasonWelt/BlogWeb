...
<template>
    <el-row class="sharelistBox">
        ...
        <el-col :span="24" class="s-item tcommonBox articleListBox" v-for="(item,index) in articleList" :key="'article'+index">
            ...
            <header>
                ...
                <div class="article-content">
                    ...
                    <p  style="max-height:300px;overflow:hidden;text-align:center;margin-top:20px;">
